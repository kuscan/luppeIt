...
public class NavigationConstants {
    ...
    public static final String registrationConfirmationPage = "/registration/registrationConfirmation.html";

    public static final String loginPage = "/login/login.html";
